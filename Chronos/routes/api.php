...
Route::middleware('not.loggedin')->group(function() {
    Route::prefix('auth')->group(function () {
        Route::post('/register',                [AuthController::class, 'register'])->withoutMiddleware('not.loggedin');
        Route::post('/login',                   [AuthController::class, 'login'])->withoutMiddleware('not.loggedin');
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::get('/main-calendar/{id}',   [UserController::class, 'mainCalendar']);
